...
int main (int argc, char** argv) {
  ...
  if (argc==2 && !strcmp(argv[1],"demo")) {
    ...
    process("img/euroc_left.pgm",  "img/euroc_right.pgm");
    process("img/euroc_left1.pgm",  "img/euroc_right1.pgm");
    process("img/euroc_left2.pgm",  "img/euroc_right2.pgm");
    process("img/left01.pgm",  "img/right01.pgm");
    cout << "... done!" << endl;
